...
BEGIN
  ...
  INSERT INTO public.sales (salon_id, customer_id, total_amount, payment_method, discount, date, idempotency_key)
  VALUES (
    p_salon_id,
    p_customer_id,
    p_total_amount,
...
REVOKE ALL ON FUNCTION public.close_sale_atomic(integer, uuid, numeric, text, numeric, jsonb, integer, text) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.close_sale_atomic(integer, uuid, numeric, text, numeric, jsonb, integer, text) FROM anon;
REVOKE ALL ON FUNCTION public.close_sale_atomic(integer, uuid, numeric, text, numeric, jsonb, integer, text) FROM authenticated;
GRANT EXECUTE ON FUNCTION public.close_sale_atomic(integer, uuid, numeric, text, numeric, jsonb, integer, text) TO service_role;
